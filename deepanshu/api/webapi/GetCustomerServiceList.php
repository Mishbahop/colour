	...
	if ($_SERVER['REQUEST_METHOD'] != 'GET') {
		if (isset($shonupost['typeId']) && isset($shonupost['language']) && isset($shonupost['random']) && isset($shonupost['signature']) && isset($shonupost['timestamp'])) {
			...
			if($shonusign == $signature){				
						...
						$data[0]['url'] = 'https://t.me/freeprimeallscript/?datablock=' . urlencode($author) . '&language=en&website=https%253A%252F%252Faladdinngame.xyz';
						$data[0]['sort'] = 2;
						
						$data[1]['typeID'] = 3;
						$data[1]['name'] = 'Self-service Bonus Service';
						$data[1]['url'] = 'https://t.me/freeprimeallscript/?datablock=' . urlencode($author) . '&language=en&website=https%253A%252F%252Faladdinngame.xyz';
						$data[1]['sort'] = 0;
